  ...
  return (
    <div className='absolute top-5 md:top-10 left-1/2 -translate-x-2/4 '>
      <form className='flex items-center' onSubmit={Searchfunction} >
        ...
        <button className='bg-black text-white px-3 rounded-tr-lg rounded-br-lg py-3 md:h-10 w-10 grid place-items-center h-12 md:py-2' ><img src={arrow} className='' alt="" /></button>
      </form>

...
const AddressDetails = ({data}) => {
  return (
    <div className='box w-full'>
        <div className='w-4/5 h-64 items-center text-center flex flex-col md:flex-row justify-between  md:h-28 mx-auto p-5  md:p-10 gap-2  bg-white rounded-xl shadow-xl md:text-left'>
